    ...
    <main className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-sm rounded-2xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
        <div className="mb-6 text-center">
          <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-2xl bg-banco-verde text-2xl font-bold text-white shadow-sm">
            P
          </div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Tus gastos, claros. Inicia sesión.
          </p>
        </div>
